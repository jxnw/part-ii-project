...
path_to_or = "../fce.train.gold.bea19.clean.or"
path_to_co = "../fce.train.gold.bea19.clean.co"
path_to_or_co = "../aligned.grow-diag-final-and"
path_to_output = "../phrase_pair_id"
