...
def preprocess_data(or_co, original_file, corrected_file):
...
train_input_tensor, train_expected_tensor = preprocess_data(path_to_or_co_train, path_to_or_train, path_to_co_train)
