...
path_to_pt_rw = "model/pt_rw"
path_to_pt_top_id = "model/pt_top_id"

path_to_hidden = "model/sparse/one_hidden_layer/hidden_epoch{}"
path_to_new_rw = "model/sparse/phrase_tables/pt_rw_{}"
path_to_new_pt = "model/sparse/phrase_tables/phrase_table_{}"
