...
\usepackage{pdfpages}   % include proposal.pdf
\usepackage{listings}   % code
\usepackage{multirow}   % table
\usepackage{pmboxdraw}  % repository overview
\usepackage{amsmath}    % math
\usepackage{amsfonts}   % checkmark
\usepackage{algorithm}  % algorithm
\usepackage{algpseudocode}  % algorithm
\usepackage{float}      % figure
\usepackage[linguistics]{forest}    % tree
...
% \includegraphics[trim={0 0 5.2cm 0},clip,width=0.25\textwidth]{DCST_Colour.png}
...
\bigskip
\leftline{Signed \textit{Jiaxin Wang}}
